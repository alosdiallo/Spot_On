...
#convert matrix to TXT file
matrix2TXT($centerLineMatrix,$height,$width,$debugPath.".clean.centers.lines.outer.txt") if($debugMode == 1);
#convert matrix to PNG image
matrix2PNG($centerLineMatrix,$height,$width,$backgroundClusterNumber,$debugPath.".clean.centers.lines.outer.png") if($debugMode == 1);
